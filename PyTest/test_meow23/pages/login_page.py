...
class LoginPage(BasePage):
    def login_in_account(self):
        self.browser.find_element(*MainPageLocators.INPUT_USER_NAME).send_keys(*MainPageLocators.BASE_USERNAME) 
        self.browser.find_element(*MainPageLocators.INPUT_PASSWORD).send_keys(*MainPageLocators.BASE_PASSWORD)  
    ...
    def reg_old_account(self):
        self.browser.find_element(*LoginPageLocators.REG_NEW_USER_NAME).send_keys(*MainPageLocators.BASE_USERNAME) 
        self.browser.find_element(*LoginPageLocators.REG_NEW_EMAIL).send_keys(*LoginPageLocators.BASE_USER_EMAIL)  
        self.browser.find_element(*LoginPageLocators.REG_NEW_PASSWORD).send_keys(*MainPageLocators.BASE_PASSWORD)  
        self.browser.find_element(*LoginPageLocators.REGISTER_BUTTON).click()  
